...
══ Divergence Explanations ══
  ...
  [Critical] W-EP-01 — only in COU A
    COU1: Claim has no prov:wasDerivedFrom link to evidence —
...
src/uofa_cli/                    # uofa CLI package
  ...
  explain.py                     # generic divergence explanation (reads WeakenerAnnotation.description)
