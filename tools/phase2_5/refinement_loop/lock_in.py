...
Usage:
    ...
    python -m tools.phase2_5.lock_in --rule W-EP-01 --iteration 1 \
        --new-outcomes out/phase2_5/.../w_ep_01_iter01/coverage/outcomes.csv \
...
from tools.phase2_5.refinement_loop.metrics import AFFECTED_RULES, compute_metrics
...
def decide(baseline, post) -> tuple[str, str, bool]:
    ...
    """
    from tools.phase2_5.refinement_loop.refine_loop import (
