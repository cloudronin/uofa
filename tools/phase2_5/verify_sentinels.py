...
CLI: ``python -m tools.phase2_5.verify_sentinels --rule W-EP-01 \\
        --post-outcomes out/phase2_5/.../milestones/after_w_ep_01.csv``
"""
...
from tools.phase2_5.metrics import AFFECTED_RULES
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.split_path is None:
        ...
        args.split_path = Path(
            f"out/phase2_5/2026-04-27/splits/{rule_slug}_split.json"
        )
