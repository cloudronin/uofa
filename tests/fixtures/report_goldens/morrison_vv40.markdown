# Credibility report — COU1: Cardiopulmonary bypass use (Class II)
...
| Factor | Status |
|---|---|
| Equivalency of input parameters | Not stated |
| Model form | Not stated |
| Model inputs | Not stated |
| Numerical solver error | Not stated |
| Output comparison | Not stated |
| Relevance of the validation activities to the COU | Not stated |
| Test samples | Not stated |
| Use error | Not stated |
