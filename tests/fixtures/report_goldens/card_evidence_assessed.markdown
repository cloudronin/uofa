...
|---|---|---|---|
| 59% | 10 of 17 | 2 Critical, 10 High, 2 Moderate | 0 of 2 |

_59% of all factors evidenced; 4 factors required at Level 3 still need evidence; 12 high-severity concerns open before this is review-ready._
...
- **High concern (seen 10×).** Reported evaluation states no context-of-use relevance - the decision this score would inform is unstated. Relates to: Context-of-use relevance. _(common: most published models state no context of use)_
...
- **Critical concern (seen 10×).** Critical and High severity weakeners coexist — compounding risk escalation.
