...
test report to tests/substrate/oos_backward_substrate_test_report.json.
...
REPORT_PATH = Path(__file__).parent / "oos_backward_substrate_test_report.json"


def _run_substrate_test(java_exe: str, jar: Path, paths: dict, mode: str = "full") -> dict:
...
def test_substrate_full_run_emits_well_formed_report(java_executable, substrate_jar, substrate_paths):
    """End-to-end: run full mode, verify report has all expected sections."""
    report = _run_substrate_test(java_executable, substrate_jar, substrate_paths)
...
def test_substrate_property_a1_passes(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_property_a_hybrid_loads(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_property_b_backward_chain_executes(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_property_d_no_forward_regression(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_lhs_decomp_identifies_missing_subgoal(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_outcome_classification_is_known(java_executable, substrate_jar, substrate_paths):
...
def test_substrate_determinism(java_executable, substrate_jar, substrate_paths):
    """Run the test 3 times — firing lists must be byte-identical (PRD §7 verification)."""
    reports = [
        _run_substrate_test(java_executable, substrate_jar, substrate_paths)
        for _ in range(3)
    ]
