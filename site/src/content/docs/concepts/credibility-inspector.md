...
description: 'Mirrored from `docs/credibility-inspector.md` in the uofa repo. Edits should be made there.'
editUrl: https://github.com/cloudronin/uofa/blob/main/docs/credibility-inspector.md
---

:::note[Mirrored page]
This page is mirrored from [`docs/credibility-inspector.md`](https://github.com/cloudronin/uofa/blob/main/docs/credibility-inspector.md) in the uofa repo. Edits made here are overwritten on the next build — edit the source instead.
:::

# The Credibility Inspector

The Credibility Inspector is the usability layer over the UofA toolchain. It is
live at [uofa.net/demo](https://github.com/cloudronin/uofa/blob/main/docs/demo/), backed by a HuggingFace Space, and it runs the
...
![Step 1: the start screen and pre-upload disclosure](https://raw.githubusercontent.com/cloudronin/uofa/main/docs/img/inspector/01-start.png)
...
![Step 2: the router's proposal, open to correction](https://raw.githubusercontent.com/cloudronin/uofa/main/docs/img/inspector/02-confirm-standard.png)
...
![Step 3: the confirmation step, where human judgment enters](https://raw.githubusercontent.com/cloudronin/uofa/main/docs/img/inspector/03-confirm-status.png)
...
![Step 4: the Reviewer reading](https://raw.githubusercontent.com/cloudronin/uofa/main/docs/img/inspector/04-reviewer.png)
...
![The same analysis, Author reading](https://raw.githubusercontent.com/cloudronin/uofa/main/docs/img/inspector/05-author.png)
