...
:::note[Privacy]
Your documents are read privately inside the Space. Nothing is stored or sent to a third party. If you generate a package, that file is held only long enough for you to download it and is deleted within 30 minutes. The first analysis after the Space wakes can take a few minutes while the model loads.
:::
