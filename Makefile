...
validate:
	...
	pyshacl -s schemas/uofa.shacl.ttl -df json-ld -d examples/medical.json  -f human
	pyshacl -s schemas/uofa.shacl.ttl -df json-ld -d examples/aero.json  -f human
	pyshacl -s schemas/uofa.shacl.ttl -df json-ld -d examples/auto.json  -f human
