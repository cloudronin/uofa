...
**SUPERSEDED 2026-08-21 by `AUTHOR_SUMMARY_COU2.md`.** This packet described the walk as it
...
Artifacts in `dev/build/encoding-prep/aero-cou2/`. The package is unsigned.

| | |
|---|---|
| Source | `aero-evidence-cou2/`, synthetic bundle, admissible per §2a |
| Package | `aero-cou2.jsonld`, 19 factors, 5 evidence rows |
| Weakeners | 15 across 8 patterns |
...
**12 of 14 factors carry required equal to achieved.**
...
names a gap, and 12 of 14 is close enough to uniform that the ones which differ are
...
Decision reads see decision_rationale.pdf.

## Step 4. The weakeners (15 of them)
...
structural invariant meets its April expectation, and COU2 hard must-not-fire gate on W-AR-02 held.
...
2. **12 of 14 factors with required equal to achieved**, step 2. The highest-value
