...
CLI: ``python -m dev.tools.phase2_5.refine_loop --rule W-EP-01``
...
from dev.tools.phase2_5.refinement_loop.metrics import (
    AFFECTED_RULES,
    Metrics,
    compute_metrics,
)
...
def run_loop(
    ...
    *propose_fn* / *metrics_fn* / *inspect_fn* are dependency-injected
    ...
    if propose_fn is None:
        from dev.tools.phase2_5.refinement_loop.propose_revision import make_proposal as propose_fn
    if metrics_fn is None:
        metrics_fn = compute_metrics
    if inspect_fn is None:
        from dev.tools.phase2_5.analysis.inspect_misfires import sample_misfires as inspect_fn
