...
Phase E (post-Phase-D consolidation) nested this package under ``dev/``;
the canonical import path is now ``dev.tools.phase2_5.<subpackage>.X``.
The Phase C deprecation shims at the old top-level paths have been
removed (the one-release back-compat window is over).
"""
