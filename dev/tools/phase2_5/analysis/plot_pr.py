...
CLI:
    ``python -m dev.tools.phase2_5.plot_pr --rule W-EP-01``     # per-rule
    ``python -m dev.tools.phase2_5.plot_pr --catalog``           # milestone scatter
    ``python -m dev.tools.phase2_5.plot_pr --all``               # both, all rules
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    from dev.tools.phase2_5.refinement_loop.split import ALL_RULES
