...
Usage:
    python dev/tools/scripts/refresh_jre_manifest.py
    python dev/tools/scripts/refresh_jre_manifest.py --dry-run    # print, don't write
    python dev/tools/scripts/refresh_jre_manifest.py --check       # exit non-zero if stale
"""
