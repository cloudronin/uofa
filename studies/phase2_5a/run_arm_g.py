"""Arm G — re-classify the v0.5.13 holdout at v0.5.15.1. No LLM spend.

    PYTHONPATH=src python studies/phase2_5a/run_arm_g.py
...
HOLDOUT = Path("dev/build/adversarial/phase2/holdout-2026-04-29-v0513")
OUT = Path("studies/phase2_5a/arm_g_results.json")
...
def main() -> int:
    ...
    summary = {
        ...
        "corpus": str(HOLDOUT),
        "corpus_note": "v0.5.13 holdout, re-classified at v0.5.15.1; packages unchanged",
